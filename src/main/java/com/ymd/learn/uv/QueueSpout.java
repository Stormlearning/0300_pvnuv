...
public class QueueSpout implements IRichSpout {
	...
	public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
		...
		String[] times = {"2017-07-01 09:00:10", "2017-07-02 10:20:00", "2017-07-01 12:30:00", 
				"2017-07-02 14:00:02", "2017-07-01 18:00:09", "2017-07-02 18:00:09"};
	...
	public void nextTuple() {
		try {
			String log = this.sourcQueue.take();
			System.err.println("------------source-----------"+ log);
